                    ...
                    <div class="col-xs-12">
                        ...
                        <form class="form-horizontal" role="form">
                            <div class="form-group">
                                ...
                                <div class="col-sm-9">
                                    <input type="text" name="name" id="form-field-1" placeholder="Product Name"
                                ...
                                <div class="col-sm-9">
                                    <select name="type_id">
                                        <optgroup label="Linh kiện điện tử">
                                            <option value="5">CPU - BỘ VI XỬ LÝ</option>
                                        </optgroup>
                                        ...
                                        <optgroup label="Games net">
                                            <option value="6">Sever Game</option>
                                            <option value="7">Chuột Gaming</option>
                                        </optgroup>
                                    </select>
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                <label class="col-sm-3 control-label no-padding-right" for="form-field-1">
                                    Price </label>
                                <div class="col-sm-6">
                                    <input type="number" name="price" id="form-field-1" placeholder="Price"
                                           class="col-xs-10 col-sm-5">
                                </div>
                            </div>
                            <br/><br/>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-6">
                                    <input type="number" name="sale" id="form-field-1" placeholder="Sale"
                                           class="col-xs-10 col-sm-5">
                                </div>
                            </div>
                            <br/><br/>
