...
@section('title') Users | Shop Computer @endsection
@section('content')
    <div class="main-content">
        <div class="main-content-inner">
            ...
            <div class="page-content">
                ...
                @endif
                <div class="row">
                    <a href="{{ url('admin/user/create') }}" style="font-size: 15px ; margin-left: 15px">Create
                        New</a>
                    <br/><br/>
                    <div class="col-xs-12">
                        <!-- PAGE CONTENT BEGINS -->
                                    ...
                                    @if($users)
                                        @foreach($users as $item)
                                            <tr>
                                                ...
                                                <td>
                                                    {!! Form::open([ 'method'=>'DELETE' , 'url' =>'admin/user/'.$item->id,'role'=>'from' ]) !!}
