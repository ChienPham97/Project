...
<head>
    ...
    <title>Home | Thế Giới Phụ Kiện Số</title>
...
<body>
					...
					<div class="col-sm-6">
						<div class="contactinfo">
							<ul class="nav nav-pills">
								<li><a href="#"><i class="fa fa-phone"></i> +84 977 547 659</a></li>
								<li><a href="#"><i class="fa fa-envelope"></i> thegioiphukien@gmail.com.com</a></li>
							</ul>
						</div>
					</div>
					<div class="col-sm-6">
							...
							<ul class="nav navbar-nav collapse navbar-collapse">
								...
								<li class="dropdown"><a href="#">Danh Mục<i class="fa fa-angle-down"></i></a>
                                    <ul role="menu" class="sub-menu">
										...
										<li><a href="{{ url('product-details') }}">Chi Tiết Sản Phẩm</a></li> 
										<li><a href="{{ url('checkout') }}">Kiểm Tra Đơn Hàng</a></li> 
										<li><a href="{{ url('cart') }}">Thanh Toán</a></li> 
							...
							<div class="product-image-wrapper">
								<div class="single-products">
										<div class="productinfo text-center">
											...
											<a href="#" class="btn btn-default add-to-cart"><i class="fa fa-shopping-cart"></i>Kiểm Tra Đơn Hàng</a>
										</div>
								</div>
								<div class="choose">
					...
					<div class="category-tab"><!--category-tab-->
						<div class="col-sm-12">
							<ul class="nav nav-tabs">
								...
								<li><a href="#sunglass" data-toggle="tab">Sản Phẩm Được Yêu Thích</a></li>
								<li><a href="#kids" data-toggle="tab">Order</a></li>
								<li><a href="#poloshirt" data-toggle="tab">Quà Tặng</a></li>
								<li><a href="#poloshirt" data-toggle="tab">Hỏi | Đáp</a></li>
							</ul>
						</div>
	...
	<footer id="footer"><!--Footer-->
				...
				<div class="row">
					<div class="col-sm-2">
						<div class="companyinfo">
							<h2><span>CDT</span>-shopper</h2>
							<p class="title-footer">Chuyên cung cấp máy tính PC, Laptop, Tablet, Thiết bị văn phòng với chất lượng và giá cả tốt nhất</p>
						</div>
					</div>
					<div class="col-sm-7">
						<div class="col-sm-3">
							<div class="video-gallery text-center">
								...
								<p>Máy Tính Bảng Ipad3</p>
								<h2>21.000.000 Đồng</h2>
							</div>
						</div>
		...
		<div class="footer-widget">
			<div class="container">
				<div class="row">
					<div class="col-sm-2">
						<div class="single-widget">
							...
							<ul class="nav nav-pills nav-stacked">
								...
								<li><a href="#">Cơ Sở 4</a></li>
								<li><a href="#">Cơ Sở 5</a></li>
							</ul>
						</div>
					</div>
					<div class="col-sm-2">
						<div class="single-widget">
							<h2>Liên Hệ</h2>
							<ul class="nav nav-pills nav-stacked">
								<li><a href="#">Phạm Minh Chiến</a></li>
								<li><a href="#">Hoàng Thừa Duy</a></li>
								<li><a href="#">Nguyễn Duy Tú</a></li>
					...
					<div class="col-sm-3">
						<div class="single-widget">
							<h2 class="shop-bank">Tài Khoản Ngân Hàng</h2>
							<p class="account-bank">Phạm Minh Chiến: 0000000000000</p>
							<p class="account-bank">Hoàng Thừa Duy: 0000000000000</p>
							<p class="account-bank">Nguyễn Duy Tú: 0000000000000</p>
						</div>
					</div>
					<div class="col-sm-3">
						<div class="single-widget">
							...
							<form action="#" class="searchform">
								...
								<p>Hãy để lại email nếu bạn cần giúp đỡ</p><br /><a href="index.html">Liên Hệ Với Chúng Tôi</a>
							</form>
						</div>
					</div>
		...
		<div class="footer-bottom">
			<div class="container">
				<div class="row">
					<p class="pull-left">Copyright © 2017 CDT-SHOPPER Inc. All rights reserved.</p>
				</div>
			</div>
		</div>
