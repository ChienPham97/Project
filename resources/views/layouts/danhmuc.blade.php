    ...
    <div class="panel panel-default">
        ...
        <div id="sportswear" class="panel-collapse collapse">
            <div class="panel-body">
                <ul>
                    @foreach($lkmt as $lk)
                        <li><a href="{{ url('product_type/'.$lk->id) }}">{{ $lk->title }}</a></li>
                    @endforeach
                </ul>
            </div>
        </div>
            ...
            <div class="panel-body">
                <ul>
                    @foreach($laptop as $lt)
                        <li><a href="{{ url('product_type/'.$lt->id) }}">{{ $lt->title }}</a></li>
                    @endforeach
                </ul>
            </div>
        </div>
    ...
    <div class="panel panel-default">
        ...
        <div id="mens" class="panel-collapse collapse">
            <div class="panel-body">
                <ul>
                    @foreach($game as $g)
                        <li><a href="{{ url('product_type/'.$g->id) }}">{{ $g->title }}</a></li>
                    @endforeach
                </ul>
            </div>
        </div>
            ...
            <div class="panel-body">
                <ul>
                    @foreach($tbnghenhin as $nn)
                        <li><a href="{{ url('product_type/'.$nn->id) }}">{{ $nn->title }}</a></li>
                    @endforeach
                </ul>
            </div>
        </div>
            ...
            <div class="panel-body">
                <ul>
                    @foreach($tbluutru as $ss)
                        <li><a href="{{ url('product_type/'.$ss->id) }}">{{ $ss->title }}</a></li>
                    @endforeach
                </ul>
            </div>
        </div>
            ...
            <div class="panel-body">
                <ul>
                    @foreach($tbvanphong as $vp)
                        <li><a href="{{ url('product_type/'.$vp->id) }}">{{ $vp->title }}</a></li>
                    @endforeach
                </ul>
            </div>
        </div>
