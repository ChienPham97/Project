					...
					<div class="col-sm-8">
						<div class="shop-menu pull-right">
							<ul class="nav navbar-nav">
								...
								<li><a href="checkout.html" class="active"><i class="fa fa-crosshairs"></i> Kiểm tra đơn hàng</a></li>
							...
							<ul class="nav navbar-nav collapse navbar-collapse">
								...
								<li class="dropdown"><a href="#">Danh Mục<i class="fa fa-angle-down"></i></a>
                                    <ul role="menu" class="sub-menu">
										...
										<li><a href="checkout.html" class="active">Kiểm Tra Đơn Hàng</a></li> 
		...
		<div class="container">
			...
			<div class="checkout-options">
				<ul class="nav">
					...
					<li>
						<label><input type="checkbox"> Kiểm Tra Đơn Hàng</label>
					</li>
					<li>
						<a href="#">OK</a>
					</li>
